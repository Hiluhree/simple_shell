...
/**
 * help_all - Displays all possible builtin myshell commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the myshell builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the myshell builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the myshell builtin command 'exit'.
 */
void help_exit(void)
{
